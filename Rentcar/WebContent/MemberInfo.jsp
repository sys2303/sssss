...
<body>
<!--0.memberlist에서 넘긴 id를 받아줌   1.데이터 베이스에서 한회원의 정보를 가져옴 2.table태그를 이용하여 화면에 회원의 정보를 출력 -->
<%
...
%>
	...
	<tr height="50">
		...
		<button onclick="location.href='MemberUpadateForm.jsp?id=<%=mbean.getId()%>'"> 회원수정 </button>
